...
func ModulePulumiInlinePolicyDataSource() datasource.DataSource {
	return &modulePulumiInlinePolicyDataSource{}
}

type modulePulumiInlinePolicyDataSource struct {
	client *snapcd.Client
}

func (r *modulePulumiInlinePolicyDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *modulePulumiInlinePolicyDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *modulePulumiInlinePolicyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError(modulePulumiInlinePolicyDefaultError, "Error creating calling GET, unexpected error: "+err.Error())
		return
	}
	...
	if err != nil {
		resp.Diagnostics.AddError(modulePulumiInlinePolicyDefaultError, "Failed to convert map to struct: "+err.Error())
		return
	}
