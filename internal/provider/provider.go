...
func (p *snapcdProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		module_env_var.ModuleEnvVarFromSecretScopedToModuleDataSource,
		module_env_var.ModuleEnvVarFromSecretScopedToNamespaceDataSource,
		module_env_var.ModuleEnvVarFromSecretScopedToStackDataSource,
		...
		module_param.ModuleParamFromSecretScopedToModuleDataSource,
		module_param.ModuleParamFromSecretScopedToNamespaceDataSource,
		module_param.ModuleParamFromSecretScopedToStackDataSource,

		namespace_env_var.NamespaceEnvVarFromLiteralDataSource,
		namespace_env_var.NamespaceEnvVarFromDefinitionDataSource,
		namespace_env_var.NamespaceEnvVarFromSecretScopedToNamespaceDataSource,
		namespace_env_var.NamespaceEnvVarFromSecretScopedToStackDataSource,

		namespace_param.NamespaceParamFromLiteralDataSource,
		namespace_param.NamespaceParamFromDefinitionDataSource,
		namespace_param.NamespaceParamFromSecretScopedToNamespaceDataSource,
		namespace_param.NamespaceParamFromSecretScopedToStackDataSource,
...
func (p *snapcdProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		module_env_var.ModuleEnvVarFromSecretScopedToModuleResource,
		module_env_var.ModuleEnvVarFromSecretScopedToNamespaceResource,
		module_env_var.ModuleEnvVarFromSecretScopedToStackResource,
		...
		module_param.ModuleParamFromSecretScopedToModuleResource,
		module_param.ModuleParamFromSecretScopedToNamespaceResource,
		module_param.ModuleParamFromSecretScopedToStackResource,

		namespace_env_var.NamespaceEnvVarFromLiteralResource,
		namespace_env_var.NamespaceEnvVarFromDefinitionResource,
		namespace_env_var.NamespaceEnvVarFromSecretScopedToNamespaceResource,
		namespace_env_var.NamespaceEnvVarFromSecretScopedToStackResource,

		namespace_param.NamespaceParamFromLiteralResource,
		namespace_param.NamespaceParamFromDefinitionResource,
		namespace_param.NamespaceParamFromSecretScopedToNamespaceResource,
		namespace_param.NamespaceParamFromSecretScopedToStackResource,
