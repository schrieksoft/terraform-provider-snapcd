...
func ModuleInputFromSecretDataSource() datasource.DataSource {
	return &moduleInputFromSecretDataSource{}
}

type moduleInputFromSecretDataSource struct {
	client *snapcd.Client
}

func (r *moduleInputFromSecretDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *moduleInputFromSecretDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *moduleInputFromSecretDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError(moduleInputFromSecretDefaultError, "Error creating calling GET, unexpected error: "+err.Error())
		return
	}
	...
	if err != nil {
		resp.Diagnostics.AddError(moduleInputFromSecretDefaultError, "Failed to convert map to struct: "+err.Error())
		return
	}
