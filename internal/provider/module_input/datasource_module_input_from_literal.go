...
func ModuleInputFromLiteralDataSource() datasource.DataSource {
	return &moduleInputFromLiteralDataSource{}
}

type moduleInputFromLiteralDataSource struct {
	client *snapcd.Client
}

func (r *moduleInputFromLiteralDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *moduleInputFromLiteralDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *moduleInputFromLiteralDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Module Inputs (Parameters) --- Use this data source to access information about an existing Module Input (From Literal) in Snap CD.",
...
func (d *moduleInputFromLiteralDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if err != nil {
		resp.Diagnostics.AddError(moduleInputFromLiteralDefaultError, "Error creating calling GET, unexpected error: "+err.Error())
		return
	}
	...
	if err != nil {
		resp.Diagnostics.AddError(moduleInputFromLiteralDefaultError, "Failed to convert map to struct: "+err.Error())
		return
	}
