...
const (
	...
	ModuleReadDto_StateMigrationApprovalThreshold    = "The number of Users (or Service Principals) that need to approve before a state migration (a split or transfer job) pushes state. Setting this will override any default value set on the Module's parent Namespace. If set neither on Module nor on Namespace then a threshold of 1 is used, since the push is irreversible."
	...
	ModuleUpdateDto_StateMigrationApprovalThreshold    = "The number of Users (or Service Principals) that need to approve before a state migration (a split or transfer job) pushes state. Setting this will override any default value set on the Module's parent Namespace. If set neither on Module nor on Namespace then a threshold of 1 is used, since the push is irreversible."
	...
	NamespaceReadDto_DefaultStateMigrationApprovalThreshold = "The number of Users (or Service Principals) that need to approve before a state migration (a split or transfer job) pushes state. All modules in this Namespace will use this value, unless explicitly overriden on the Module itself. If set neither on Module nor on Namespace then a threshold of 1 is used, since the push is irreversible."
	...
	NamespaceUpdateDto_DefaultStateMigrationApprovalThreshold = "The number of Users (or Service Principals) that need to approve before a state migration (a split or transfer job) pushes state. All modules in this Namespace will use this value, unless explicitly overriden on the Module itself. If set neither on Module nor on Namespace then a threshold of 1 is used, since the push is irreversible."
