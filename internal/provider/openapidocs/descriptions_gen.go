...
const (
	...
	// ModulePauseDto
	ModulePauseDto_ModuleId    = "Unique ID of the Module."
	ModulePauseDto_PauseReason = "Operator-supplied explanation for the pause, when one was given."
	ModulePauseDto_Paused      = "True while the Module is held out of the automated lifecycle."
	ModulePauseDto_PausedAt    = "When the Module was paused, when paused."
	ModulePauseDto_PausedBy    = "ID of the principal that paused the Module, when paused."

	// ModulePauseRequestDto
	ModulePauseRequestDto_Reason = "Operator-supplied explanation for the pause. Recorded against the Module and shown while it is paused."
	...
	ModuleReadDto_SplitMonolithApprovalThreshold     = "The number of Users (or Service Principals) that need to approve before a 'SplitMonolith' job pushes state. Setting this will override any default value set on the Module's parent Namespace. If set neither on Module nor on Namespace then a threshold of 1 is used, since the push is irreversible."
	...
	ModuleUpdateDto_SplitMonolithApprovalThreshold     = "The number of Users (or Service Principals) that need to approve before a 'SplitMonolith' job pushes state. Setting this will override any default value set on the Module's parent Namespace. If set neither on Module nor on Namespace then a threshold of 1 is used, since the push is irreversible."
	...
	NamespaceReadDto_DefaultSplitMonolithApprovalThreshold = "The number of Users (or Service Principals) that need to approve before a 'SplitMonolith' job pushes state. All modules in this Namespace will use this value, unless explicitly overriden on the Module itself. If set neither on Module nor on Namespace then a threshold of 1 is used, since the push is irreversible."
	...
	NamespaceUpdateDto_DefaultSplitMonolithApprovalThreshold = "The number of Users (or Service Principals) that need to approve before a 'SplitMonolith' job pushes state. All modules in this Namespace will use this value, unless explicitly overriden on the Module itself. If set neither on Module nor on Namespace then a threshold of 1 is used, since the push is irreversible."
