...
var NamespaceParamFromSecretCreateConfig = secret.SimpleSecretCreateConfig + providerconfig.AppendRandomString(`
...
resource "snapcd_namespace_param_from_secret" "this" { 
  ...
  usage_mode = "UseByDefault"
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("snapcd_namespace_param_from_secret.this", "id"),
					resource.TestCheckResourceAttr("snapcd_namespace_param_from_secret.this", "usage_mode", "UseByDefault"),
				),
			},
		},
	})
