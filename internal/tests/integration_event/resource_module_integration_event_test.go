...
func TestAccResourceModuleIntegrationEvent_Create(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: providerconfig.ProviderConfig + core.ModuleCreateConfig + IntegrationDataSourceConfig + ModuleIntegrationEventCreateConfig,
...
func TestAccResourceModuleIntegrationEvent_Update(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: providerconfig.ProviderConfig + core.ModuleCreateConfig + IntegrationDataSourceConfig + ModuleIntegrationEventUpdateConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("snapcd_module_integration_event.this", "id"),
