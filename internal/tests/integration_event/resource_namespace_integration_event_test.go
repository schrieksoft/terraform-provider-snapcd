...
func TestAccResourceNamespaceIntegrationEvent_Create(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: providerconfig.ProviderConfig + core.NamespaceCreateConfig + IntegrationDataSourceConfig + NamespaceIntegrationEventCreateConfig,
...
func TestAccResourceNamespaceIntegrationEvent_Update(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: providerconfig.ProviderConfig + core.NamespaceCreateConfig + IntegrationDataSourceConfig + NamespaceIntegrationEventUpdateConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("snapcd_namespace_integration_event.this", "id"),
