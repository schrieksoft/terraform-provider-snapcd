...
var ModuleEnvVarFromLiteralCreateConfig = providerconfig.AppendRandomString(`
...
func TestAccResourceModuleEnvVarFromLiteral_Create(t *testing.T) {
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: providerconfig.ProviderConfig + core.ModuleCreateConfig + ModuleEnvVarFromLiteralCreateConfig,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("snapcd_module_env_var_from_literal.this", "id"),
					resource.TestCheckResourceAttr("snapcd_module_env_var_from_literal.this", "name", providerconfig.AppendRandomString("somevalue%s")),
				),
			},
			{
