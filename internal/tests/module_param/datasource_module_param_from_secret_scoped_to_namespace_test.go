...
func TestAccDataSourceModuleParamFromSecretScopedToNamespace(t *testing.T) {
...
data "snapcd_module_param_from_secret_scoped_to_namespace" "this" {
	...
	module_id 	                        = snapcd_module_param_from_secret_scoped_to_namespace.this.module_id
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.snapcd_module_param_from_secret_scoped_to_namespace.this", "id"),
					resource.TestCheckResourceAttr("data.snapcd_module_param_from_secret_scoped_to_namespace.this", "name", providerconfig.AppendRandomString("somevalue%s")),
				),
			},
		},
	})
