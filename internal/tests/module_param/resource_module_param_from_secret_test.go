...
var ModuleParamFromSecretCreateConfig = secret.SimpleSecretScopedToStackCreateConfig + providerconfig.AppendRandomString(`
...
resource "snapcd_module_param_from_secret" "this" { 
  ...
  type = "NotString"
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("snapcd_module_param_from_secret.this", "id"),
					resource.TestCheckResourceAttr("snapcd_module_param_from_secret.this", "type", "NotString"),
				),
			},
		},
	})
