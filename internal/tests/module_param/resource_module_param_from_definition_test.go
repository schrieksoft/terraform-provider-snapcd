...
var ModuleParamFromDefinitionCreateConfig = providerconfig.AppendRandomString(`
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("snapcd_module_param_from_definition.this", "id"),
					resource.TestCheckResourceAttr("snapcd_module_param_from_definition.this", "name", providerconfig.AppendRandomString("somevalue%s")),
				),
			},
			{
