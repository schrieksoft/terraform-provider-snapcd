...
- `apply_after_hook` (String, Deprecated) Shell script that should be executed after the 'Apply' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
...
- `apply_before_hook` (String, Deprecated) Shell script that should be executed before the 'Apply' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
...
- `auto_migrate_enabled` (Boolean, Deprecated) Deprecated: Use Terraform Flag resources instead. Setting this to true will add the `-migrate-state` flag whenever `init` is called. Setting this will override any default value set on the Module's parent Namespace.
- `auto_reconfigure_enabled` (Boolean, Deprecated) Deprecated: Use Terraform Flag resources instead. Setting this to true will add the `-reconfigure` flag whenever `init` is called. Setting this will override any default value set on the Module's parent Namespace.
- `auto_upgrade_enabled` (Boolean, Deprecated) Deprecated: Use Terraform Flag resources instead. Setting this to true will add the `-upgrade` flag whenever `init` is called. Setting this will override any default value set on the Module's parent Namespace.
...
- `destroy_after_hook` (String, Deprecated) Shell script that should be executed after the 'Destroy' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
...
- `destroy_before_hook` (String, Deprecated) Shell script that should be executed before the 'Destroy' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
...
- `ignore_namespace_hooks` (Boolean) If this is set to true, any Hooks (Namespace Hooks and the deprecated default_*_hook fields) that have been set on Namespace level will not be used on this specific Module.
- `init_after_hook` (String, Deprecated) Shell script that should be executed after the 'Init' step of any deployment is run.Setting this will override any default value set on the Module's parent Namespace.
- `init_before_hook` (String, Deprecated) Shell script that should be executed before the 'Init' step of any deployment is run.Setting this will override any default value set on the Module's parent Namespace.
- `output_after_hook` (String, Deprecated) Shell script that should be executed after the 'Output' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
- `output_before_hook` (String, Deprecated) Shell script that should be executed before the 'Output' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
...
- `plan_after_hook` (String, Deprecated) Shell script that should be executed after the 'Plan' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
- `plan_before_hook` (String, Deprecated) Shell script that should be executed before the 'Plan' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
- `plan_destroy_after_hook` (String, Deprecated) Shell script that should be executed after the 'Destroy' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
- `plan_destroy_before_hook` (String, Deprecated) Shell script that should be executed before the 'Destroy' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
...
- `validate_after_hook` (String, Deprecated) Shell script that should be executed after the 'Validate' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
- `validate_before_hook` (String, Deprecated) Shell script that should be executed before the 'Validate' step of any deployment is run. Setting this will override any default value set on the Module's parent Namespace.
