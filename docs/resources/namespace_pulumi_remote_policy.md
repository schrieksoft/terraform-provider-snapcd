---
page_title: "snapcd_namespace_pulumi_remote_policy Resource - snapcd"
subcategory: "Policies"
description: |-
  Manages a Namespace Pulumi Remote Policy in Snap CD.
---

# snapcd_namespace_pulumi_remote_policy (Resource)
...
terraform import snapcd_namespace_pulumi_remote_policy.this $RESOURCE_ID
```
